        ...
        public void Render(RenderingContext renderingContext)
        {
            for (int i = 0; i < _mesh.GetTriangles().Length; i++)
            {
                 ...
                 )
                {
                    ...
                    Drawer.DrawTriangle(renderingContext, triangleVertex0Proj, triangleVertex1Proj, triangleVertex2Proj, _fillColor);
                    ...
                    Drawer.DrawLine(renderingContext, triangleVertex0Proj, triangleVertex1Proj, _edgeColor);
                    Drawer.DrawLine(renderingContext, triangleVertex1Proj, triangleVertex2Proj, _edgeColor);
                    Drawer.DrawLine(renderingContext, triangleVertex2Proj, triangleVertex0Proj, _edgeColor);
                }
            }
        }
    }
