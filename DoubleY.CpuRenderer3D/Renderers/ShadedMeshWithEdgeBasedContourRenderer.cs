...
{
    public class ShadedMeshWithEdgeBasedContourRenderer<TFragmentData> : IRenderer where TFragmentData : struct
    {
        ...
        public ShadedMeshWithEdgeBasedContourRenderer(Mesh mesh, IShaderProgram<TFragmentData> shaderProgram, IInterpolator<FragmentInput<TFragmentData>> interpolator, Vector4 contourColor)
        {
            _mesh = mesh;
